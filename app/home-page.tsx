    ...
    <main id="main">
      ...
      <section className="intro-section container" id="expertise" aria-labelledby="expertise-heading">
        ...
        <div className="expertise-grid">
          ...
          <article className="expertise-item"><span className="item-number">03</span><h3>Events &<br/>programming</h3><p>Create a reason to come together. Business workshops, founder experiences, and commissioned programming for venues and organizations.</p><a className="text-link" href="#gather">Bring people together <ArrowUpRight size={18}/></a></article>
        </div>
      </section>
...
<section className="perspective-section" aria-labelledby="perspective-heading"><div className="container perspective-inner">
      ...
      <section className="firm-section container" id="firm" aria-labelledby="firm-heading">
        ...
        <div className="founders"><article><figure className="home-founder-photo"><img src="/images/ryan-placeholder.png" width="1024" height="1280" alt="Illustrative portrait of a Black woman; Ryan’s photo to follow" loading="lazy"/><figcaption>Illustrative portrait</figcaption></figure><div className="founder-top"><span className="founder-initial" aria-hidden="true">RB</span><span className="eyebrow">Co-founder</span></div><h3>Ryan Brown</h3><p className="founder-role">Business strategy & coaching</p><p>Ryan leads the business decisions: the plan, the offer, and the work of helping owners and teams put change into practice. She also shapes our events and venue programming.</p></article><article><figure className="home-founder-photo"><img src="/images/johnny-placeholder.png" width="1024" height="1280" alt="Illustrative portrait of a Black man; Johnny’s photo to follow" loading="lazy"/><figcaption>Illustrative portrait</figcaption></figure><div className="founder-top"><span className="founder-initial" aria-hidden="true">JG</span><span className="eyebrow">Co-founder</span></div><h3>Johnny B. Gaines III</h3><p className="founder-role">Applied AI & systems</p><p>Johnny builds the systems behind the strategy, connecting tools, workflows, and customer experiences around the way each business needs to operate.</p></article></div></div>
      </section>
